...
CREATE TABLE IF NOT EXISTS `PEEF_BD`.`ENHANCEDMESSAGE` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `code` VARCHAR(45) NULL DEFAULT NULL,
  `original` LONGTEXT NULL DEFAULT NULL,
  `enhanced` LONGTEXT NULL DEFAULT NULL,
...
START TRANSACTION;
USE `PEEF_BD`;
INSERT INTO `PEEF_BD`.`PROFESSOR` (`id`, `name`, `email`, `password`, `bio`, `institution`) VALUES (1, 'Professor Teste', 'teste@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 'Usuário Teste', 'TESTE');
...
START TRANSACTION;
USE `PEEF_BD`;
INSERT INTO `PEEF_BD`.`ACTIVITY` (`id`, `description`, `image`, `title`, `Course_id`, `description_input`, `description_output`, `ACTIVITYcol`) VALUES (1, 'Escreva um algoritmo para calcular a soma de dois numeros A e B.', 'teste.png', 'Atividade 01', 1, 'Dois valores inteiros', 'Imprima o valor da soma. Cuide para que tenha um espaco antes e depois do sinal de igualdade, conforme o exemplo abaixo.', NULL);
...
START TRANSACTION;
USE `PEEF_BD`;
INSERT INTO `PEEF_BD`.`STUDENT` (`id`, `name`, `email`, `password`, `bio`) VALUES (1, 'Teste', 'teste@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 'Usuário Teste');
INSERT INTO `PEEF_BD`.`STUDENT` (`id`, `name`, `email`, `password`, `bio`) VALUES (2, 'Teste2', 'teste2@gmail.com', '827ccb0eea8a706c4c34a16891f84e7b', 'Usuário Teste');
...
START TRANSACTION;
USE `PEEF_BD`;
INSERT INTO `PEEF_BD`.`ACTION` (`id`, `nome`) VALUES (1, 'enter');
INSERT INTO `PEEF_BD`.`ACTION` (`id`, `nome`) VALUES (2, 'out');
