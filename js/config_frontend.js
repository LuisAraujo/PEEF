...
function createActivity() {
    ...
    createNewActivity($("#selectcourses_createactivity").val(),    $("#newactivityname").val(), $("#textdescription").val(),
        $("#textdescriptionin").val(),$("#textdescriptionout").val(), $("#datadelivery").val(),  arr );
