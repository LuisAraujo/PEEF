<?php
//Calcula todas as edições de uma data atividade
...
$query = "SELECT id FROM project WHERE Activity_id  in (SELECT  id FROM Activity WHERE  Topic_id in (SELECT id FROM Topic WHERE Course_id =  '$idcourse' ))";
