...
$sql = "SELECT name, email, bio, SEXY_id as sexy, sis_language.id as idlang, sis_language.cod as cod FROM student LEFT JOIN sis_language ON sis_language.id = language_id WHERE student.id = ".getcurrentuser_session();
