        ...
        if(param == "id") {
            ...
            checkPermisionProject(getidproject, function (data) {
                if(parseInt(data) != 0){
                    ...
                    getInfoCode(idproject, setDataStudent);
...
function setDataStudent(data) {
        ...
        if(data.id != undefined) {
            $("#status_typeerro").show();
            $("#status_lineerro").show();
            $("#status_testpassed").show();
            $("#status_erromsg").show();
        }else {
            $("#status_typeerro").hide();
            $("#status_lineerro").hide();
            $("#status_testpassed").hide();
            $("#status_erromsg").hide();
        }
